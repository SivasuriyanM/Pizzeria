    ...
    <div className="container py-4">
      <div className="row mb-4">
        <div className="col-12 text-center">
          <h1 className="display-4 fw-bold" style={{ color: '#e74c3c' }}>Build Your Own Pizza</h1>
          <p className="lead" style={{ color: '#7f8c8d' }}>Customize your pizza by choosing ingredients from the list below</p>
        </div>
      </div>
